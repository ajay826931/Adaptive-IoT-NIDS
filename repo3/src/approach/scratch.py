...
class Appr(Inc_Learning_Appr):
    """
    My implementation of the scratch baseline approach.
    This trains the model from scratch for each task without retaining past weights.
    """
