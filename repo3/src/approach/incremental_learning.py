...
class Inc_Learning_Appr:
    """
    My core base class for incremental learning.
    All specific approaches (like scratch or joint) will inherit from this.
    """
    ...
    def extra_parser(args):
        """Returns a parser containing the approach-specific parameters for my models"""
